...
As using the full dataset can become somewhat unwieldy for the examples in this section, we will create/use a subset of the *GESIS Panel Special Survey on the Coronavirus SARS-CoV-2 Outbreak in Germany* data. We will select the variables on the following:
- demographics
- political orientation
- risk perceptions
- personal measures taken
- adherence to potential curfew (only main item)
