...
We'd again like to invite you to learn more about `broom` and related developments. Last year, Alex Hayes, one author of the package, [gave an excellent talk at the RStudio Conference](https://rstudio.com/resources/rstudioconf-2019/solving-the-model-representation-problem-with-broom/), which is worthwhile to watch.