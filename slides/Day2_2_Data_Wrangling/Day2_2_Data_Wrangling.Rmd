...
```{r, wrangling_cartoon, out.width = "95%", echo = F}
...
.smaller[
```{r ref.label = "select_unselect", echo = F}
```
]
...
.smaller[
```{r ref.label = "select_type", echo = F}
```
]
...
```{r, relocate_cartoon, out.width = "85%", echo = F}
...
```{r, filter_cartoon, out.width = "95%", echo = F}
...
```{r, mutate_cartoon, out.width = "60%", echo = F}
...
```{r recode, eval = F}
gesis_panel_corona <- gesis_panel_corona %>% 
  mutate(hzcy052a = recode(hzcy052a,
...
```{r, case_when_cartoon, out.width = "95%", echo = F}
