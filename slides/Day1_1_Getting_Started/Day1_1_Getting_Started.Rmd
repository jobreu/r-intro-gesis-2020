...
Alternatively to using the `History` tab you can also use the shortcut <kbd>Ctrl + R</kbd> (*Windows* & *Linux*)/<kbd>Cmd + R</kbd> (*Mac*) and interactively search for past commands, and select them while typing.
