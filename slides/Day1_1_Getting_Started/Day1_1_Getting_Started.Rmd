...
*RStudio* is the most widely used IDE for `R`. In addition to the general advantages of IDE, it has some specific ones:
...
Two helpful resources for finding `R` packages are:
  ...
  - [CRAN Task Views](https://cran.r-project.org/) provides curated lists of recommended packages for specific tasks/areas/topics
