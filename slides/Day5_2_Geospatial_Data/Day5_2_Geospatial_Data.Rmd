...
The `tmap` package is a great resource to create fast and good looking maps. You should definitely have a look at the [introductionary vignette](https://cran.r-project.org/web/packages/tmap/vignettes/tmap-getstarted.html) of the package here. What's also great about the package is that you can also create nice interactive maps using the [`leaflet` framework](https://leafletjs.com/).
