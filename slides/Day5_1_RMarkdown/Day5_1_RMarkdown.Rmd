...
However, for computationally intensive tasks, you could consider setting the option `opts_chunk$set(cache = TRUE)`. It will cache chunk calls and their results as long as you do not edit them (but beware that potentially sensitive data could be stored in the cache).
---
...
# [Exercise](https://jobreu.github.io/r-intro-gesis-2020/exercises/Day5_1_RMarkdown_Exercise_question.html) time `r ji("weight_lifting_woman")``r ji("muscle")``r ji("running_man")``r ji("biking_man")`
