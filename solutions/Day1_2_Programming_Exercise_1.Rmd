...
Have a look at this vector `numeric_vector <- c(1, 2, 3, "four")`. Create an if-else loop that checks whether this vector really comprises numeric values, prints out a corresponding message if yes, and the same if it does not comprise numeric values.
```
