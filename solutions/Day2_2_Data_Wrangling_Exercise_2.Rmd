...
Our aim for this exercises is to use individual data files from *Gapminder* to create combined datasets that resembles the one included in the `gapminder` package.
