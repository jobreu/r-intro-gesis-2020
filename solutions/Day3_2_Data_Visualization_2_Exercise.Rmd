...
We load the gapminder GDP data from the CSV file and convert it to long format (as in the data wrangling session).
...
Create an indicator variable for the periods 1960-1969, 2002-2011 and the time in between.
```
