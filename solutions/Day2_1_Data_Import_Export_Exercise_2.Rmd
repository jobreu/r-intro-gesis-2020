...
gp_covid <-
  read_spss("../data/gesis_panel_covid19/ZA5667_v1-1-0.sav")
```
...
Unfortunately, it's all in German. Imagine you are an education researcher and you are interested in the variable `education_cat`. So you may want to consider to translate the variable into English?
...
Your colleague asks you for providing your new data after changing labels and stuff. Unfortunately, she does not use `R` or `SPSS` and asks you for exporting your data as a Stata file.
